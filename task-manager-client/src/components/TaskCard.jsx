...
const TaskCard = ({ task, setEditingTask, deleteTask, changeTaskStatus }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow rounded-lg border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center space-x-2 ml-4">
            <button
              ...
              className="p-2 text-gray-400 dark:text-gray-500 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-md transition-colors"
            >
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {task.status !== 'Pending' && (
            <button
              ...
              className="px-3 py-1 text-xs font-medium text-yellow-800 dark:text-yellow-400 bg-yellow-100 dark:bg-yellow-900/20 rounded-full hover:bg-yellow-200 dark:hover:bg-yellow-900/30 transition-colors"
            >
              Mark Pending
            </button>
          )}
          {task.status !== 'In Progress' && (
            <button
              ...
              className="px-3 py-1 text-xs font-medium text-blue-800 dark:text-blue-400 bg-blue-100 dark:bg-blue-900/20 rounded-full hover:bg-blue-200 dark:hover:bg-blue-900/30 transition-colors"
            >
              Mark In Progress
            </button>
          )}
          {task.status !== 'Completed' && (
            <button
              ...
              className="px-3 py-1 text-xs font-medium text-green-800 dark:text-green-400 bg-green-100 dark:bg-green-900/20 rounded-full hover:bg-green-200 dark:hover:bg-green-900/30 transition-colors"
            >
              Mark Completed
            </button>
          )}
